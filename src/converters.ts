...
type CommandCodeUserContent = string | readonly Record<string, string>[]

function userContentToCommandCode(content: unknown, allowImages: boolean): CommandCodeUserContent {
